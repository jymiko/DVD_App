            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b><span class="dark-logo">Video Store Admin</span></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="collapse  " href="#" aria-expanded="false"><i class="fa fa-tachometer"></i>Dashboard</a>
                        </li>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Product Detail</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="email-inbox.html">View Product</a></li>
                            </ul>
                        </li>
